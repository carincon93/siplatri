...
@section('content')
    <div class="container">
        ...
        <form class="" action="{{ route('franjas.store') }}" method="post">
            @csrf

            <div class="form-group">
                <label for="horaInicio" class="col-form-label text-md-right">{{ __('Hora inicio') }}</label>
                <input id="horaInicio" type="time" name="horaInicio" class="form-control{{ $errors->has('horaInicio') ? ' is-invalid' : '' }}" required>
            ...
            <div class="form-group">
                ...
                <input id="horaFin" type="time" name="horaFin" class="form-control{{ $errors->has('horaFin') ? ' is-invalid' : '' }}" required>
